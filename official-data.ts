...
export const defaultStalls: DefaultStall[] = [
  ...
  { id: 'E19', num: 19, desk: 1, circleImg: '', circleTitle: '怎麼會中了室町忍者的毒', links: 'https://www.plurk.com/kafu945' },
  { id: 'E20', num: 20, desk: 1, circleImg: '', circleTitle: '謝謝你敏原', links: 'https://www.facebook.com/profile.php?id=100050201773191' },
  { id: 'E22', num: 22, desk: 1, circleImg: '', circleTitle: '似個晴天', links: 'https://www.facebook.com/maho2202002/' },
  { id: 'E24', num: 24, desk: 1, circleImg: '', circleTitle: '極東霓虹實驗室', links: 'https://www.plurk.com/HOLIDAY_9NightKnight' },
  { id: 'F01', num: 1, desk: 1, circleImg: '', circleTitle: '忍者小企鵝', links: 'https://www.plurk.com/n_i_u' },
  { id: 'F02', num: 2, desk: 1, circleImg: '', circleTitle: 'Border駐台辦事處', links: 'https://privatter.me/user/rei_oktnk' },
  { id: 'F03', num: 3, desk: 1, circleImg: '', circleTitle: '長次的鮭魚沒被搶', links: 'https://www.doujin.com.tw/authors/info/sinistergod' },
  { id: 'F04', num: 4, desk: 1, circleImg: '', circleTitle: '六年ろ組隔壁的偷窺狂', links: 'https://www.pixiv.net/users/5103760' },
  { id: 'F05', num: 5, desk: 1, circleImg: '', circleTitle: '中在家長次身上為什麼帶著墨汁', links: 'https://www.doujin.com.tw/authors/info/Horklump_Arwa' },
  { id: 'F06', num: 6, desk: 1, circleImg: '', circleTitle: '小黃瓜縱著放', links: 'https://www.plurk.com/u/Xiao_Ran' },
  { id: 'F07', num: 7, desk: 1, circleImg: '', circleTitle: '利土＜我們CP打架了＞土尊', links: 'https://www.plurk.com/m01284' },
  { id: 'F08', num: 8, desk: 1, circleImg: '', circleTitle: 'お兄ちゃんの魚漿工坊', links: 'https://www.plurk.com/p/3hfd5vbpui' },
  { id: 'F09', num: 9, desk: 1, circleImg: '', circleTitle: '旋轉跳躍我閉著眼', links: 'https://www.plurk.com/twelve474719' },
  { id: 'F10', num: 10, desk: 1, circleImg: '', circleTitle: '竹影間', links: 'https://www.plurk.com/siari1215' },
  { id: 'F11', num: 11, desk: 1, circleImg: '', circleTitle: '我家食堂', links: 'https://www.plurk.com/bagyu10' },
  { id: 'F12', num: 13, desk: 2, circleImg: '', circleTitle: '繪茶委員會', links: '' },
  { id: 'F14', num: 14, desk: 1, circleImg: '', circleTitle: '又偷留文不仙說', links: 'https://www.plurk.com/jojosunny' },
  { id: 'F15', num: 15, desk: 1, circleImg: '', circleTitle: '荒屋', links: 'https://x.com/U_uxu_U_o' },
  { id: 'F16', num: 16, desk: 1, circleImg: '', circleTitle: 'U2645', links: 'https://www.plurk.com/x666mid' },
  { id: 'F17', num: 17, desk: 1, circleImg: '', circleTitle: '四島畫忍者', links: 'https://x.com/gyu44555' },
  { id: 'F18', num: 18, desk: 1, circleImg: '', circleTitle: '想和好就畫兔子吧', links: 'https://www.plurk.com/ranaapple' },
  { id: 'F19', num: 19, desk: 1, circleImg: '', circleTitle: '千兔球', links: 'https://www.plurk.com/sentokyu' },
  { id: 'F20', num: 20, desk: 1, circleImg: '', circleTitle: '魚旗神社', links: 'https://www.plurk.com/gssk20161228' },
  { id: 'F21', num: 21, desk: 1, circleImg: '', circleTitle: '五穀雜糧XTaCAt', links: 'https://www.plurk.com/p/3h7bw63vqc' },
  { id: 'F22', num: 22, desk: 1, circleImg: '', circleTitle: '訥就一瞳出忍務', links: 'https://www.plurk.com/nul321' },
  { id: 'F23', num: 23, desk: 1, circleImg: '', circleTitle: '買仙送伊，品質優異', links: 'https://www.plurk.com/love_3302159' },
  { id: 'F24', num: 24, desk: 1, circleImg: '', circleTitle: '雑渡先生的黃金獵犬', links: 'https://www.instagram.com/caraaaaaaatino/' },
